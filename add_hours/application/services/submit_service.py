...
from add_hours.application.exceptions.not_found import StudentNotFoundInDatabase
...
class SubmitService:
    ...
    def __new__(cls, submit_repository: Type[ISubmitRepository]):
    ...
    async def submit_email(cls, student_id: str):
        ...
        (
            certificates_pdf,
            total_certificates,
        ) = await StorageService.get_certificates(student_id)
